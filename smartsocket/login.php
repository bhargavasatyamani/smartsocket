    ...
    <div class="container-fluid bodycontainer">
        <div class="row">
            ...
            <div class="col-md-5 indexPageRightDiv">
                ...
                ?>
                <div style="text-align:center"><h3 style="font-family:'Nova Flat', cursive">LOGIN</h3></div><br /><br />
               <div class="container formcontainer">
                    <form method="POST" action="signin.php">
                            ...
                            <div style="text-align:center"><button type="submit" class="btn btn-primary" name="signin">LOGIN</button></div>
                    </form><br />
                    <div style="text-align:center"><a href="#">Forgot Password?</a></div>
                    <div style="text-align:center"><a href="register.php">New User? Sign up Here</a></div>
               </div> 
            </div>
        </div>
